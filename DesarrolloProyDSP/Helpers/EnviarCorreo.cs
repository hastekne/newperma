...
namespace DesarrolloProyDSP.Helpers
{
    ...
    {
        /// <summary>
        /// Método para enviar correos desde mi cuenta institucional SEG
        /// Dependiendo del parámetro tipoSubject se determina la estructura del correo
        /// </summary>
        /// <param name="tipoSubject"></param>
        /// <param name="parametro1Msg"></param>
        /// <param name="receiver"></param>
        /// <param name="parametro2Msg"></param>
        /// <param name="parametro3Msg"></param>
        public void EnviarEmail(string tipoSubject, string parametro1Msg, string receiver, string parametro2Msg="",string parametro3Msg="")
        {
            ...
            var senderEmail = new MailAddress("mc_mendoza@seg.guanajuato.gob.mx", "Martha Mendoza");
